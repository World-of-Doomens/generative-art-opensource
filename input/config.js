 ...
 *************************************************************/
 ...
 const addLayer = (_id, _position, _size) => {
   ...
   rarityWeights.forEach((rarityWeight) => {
     let elementsForRarity = getElements(`${dir}/${_id}/${_gender}/${rarityWeight.value}`);
 ...
 // TODO: input env value for config variables
 // image width in pixels
 const width = process.env.WIDTH || 1000;
 // image height in pixels
 const height = process.env.HEIGHT || 1000;
 // description for NFT in metadata file
 const description = process.env.DESCRIPTION || "This is an NFT made by the coolest generative code.";
 ...
 const baseImageUri = process.env.BASE_IMAGE_URL || "https://hashlips/nft";
 ...
 const gender = process.env.GENDER || 0
